...
avaliable_modules += plugin1 plugin2 extension qmlplugin
...
contains(enabled_modules, extension){
    INCLUDEPATH *= $$PWD/lib
...
contains(enabled_modules, qmlplugin){
    QML_IMPORT_PATH = $$OUTPUT_PWD #/YmwPlugin
#    INCLUDEPATH *= $$PWD/YmwPlugin

    LIBS += -L$$OUTPUT_PWD/YmwPlugin -lYmwPlugin
}
