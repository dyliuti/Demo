...
contains( DEFINES, YMW_QML_PLUGIN ){
    win32:DESTDIR = $$OUTPUT_PWD/YmwPlugin
    macx:DESTDIR = "$$OUTPUT_PWD/$$TARGET_BUNDLE_NAME/Contents/Library/YmwPlugin"
    unix:!macx:DESTDIR = $$OUTPUT_PWD/YmwPlugin
}
